...
<section class="stats">
    <div class="container container--85">
        ...
        <div class="stats--item">
            <em><c:out value="${donationsAmount}"/></em>
                ...
                <c:choose>
                    <c:when test="${loopStatus.index%2==0}">
                        ...
                        <c:if test="${loopStatus.last}">
                            <div class="col">
                                <div class="title" style="color: white">placeholder</div>
                                <div class="subtitle" style="color: white">placeholder</div>
                            </div>
                            </li>
                        </c:if>
                    </c:when>
